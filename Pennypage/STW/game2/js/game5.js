var Game = (function(){
    ...
    Game.prototype = {
        ...
        winning: function () {
            setTimeout(function () {
                var str = "Congratulations！Continue game? 💗";
                alert(str);
                location.reload();
            }, 50);
        },
		...
		showWords: function () {
           var words = ["Mysterious Area 51",
    "Higher Civilization",
    "Legend has it that they came to Earth to build the pyramids.",
    "Frequent use of saucer-shaped flying objects",
    "Frequently appearing in science fiction movies and novels",
    "ET",
    "Men in Black",
    "Strange looks and even nausea",
    "Good at  Mathematics",
    ...
    "Human ancestors?",];
		...
		/*answerQuestion: function () {
            var answer;
			answer = prompt("魔镜魔镜告诉我，谁是世界上最漂亮的女人？");
            if(answer =="Hime"){
				alert("回答正确！游戏结束。确定再来一局吗？");
				 location.reload();   
			} else{
			   alert("回答错误！游戏继续！");
			}
